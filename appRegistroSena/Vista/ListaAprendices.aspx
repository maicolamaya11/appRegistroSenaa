<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Coordinador.Master" AutoEventWireup="true" CodeBehind="ListaAprendices.aspx.cs" Inherits="appRegistroSena.Vista.ListaAprendices" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
    <h1 class="titulo-h1">LISTADO APRENDICES</h1>
    <section>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" style="margin-left: 190px;" runat="server">
        <ContentTemplate>
            <asp:GridView ID="gvAprendiz" runat="server" DataKeyNames="idUsuario" AutoGenerateColumns="False" Style="width: 70%; text-align: center; margin-left: 190px; margin-top: 49px;" CssClass="styled-table">
