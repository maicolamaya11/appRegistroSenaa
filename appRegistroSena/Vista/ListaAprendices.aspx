...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" style="margin-left: 190px;" runat="server">
        <ContentTemplate>
            <asp:GridView ID="gvAprendiz" runat="server" DataKeyNames="idUsuario" AutoGenerateColumns="False" Style="width: 70%; text-align: center; margin-left: 300px; margin-top: 49px;" CssClass="styled-table">
